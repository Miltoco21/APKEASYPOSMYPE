...
class Product extends Model implements IProduct {
  ...
  static logicaRedondeoUltimoDigito(valor) {
    ...
    const ultTotalStr = totalStr.substring(
      totalStr.length - 1,
      totalStr.length
    );
  ...
  async findByDescription(
    ...
    var url =
      BaseConfig.urlBase +
      "/api/ProductosTmp/GetProductosByDescripcion?descripcion=" +
      (description + "");
    if (codigoCliente) {
  ...
  async findByDescriptionPaginado(
    ...
    var url =
      BaseConfig.urlBase +
      "/api/ProductosTmp/GetProductosByDescripcionPaginado?descripcion=" +
      (description + "");
    if (codigoCliente) {
      url += "&codigoCliente=" + codigoCliente;
    }
  ...
  async findByCodigo(
    ...
    var url =
      BaseConfig.urlBase +
      "/api/ProductosTmp/GetProductosByCodigo?idproducto=" +
      codigoProducto;
    if (codigoCliente) {
      url += "&codigoCliente=" + codigoCliente;
    }
  ...
  async findByCodigoBarras(
    ...
    var url =
      BaseConfig.urlBase +
      "/api/ProductosTmp/GetProductosByCodigoBarra?codbarra=" +
      codigoProducto;
    if (codigoCliente) {
      url += "&codigoCliente=" + codigoCliente;
    }
  ...
  async getCategories(callbackOk, callbackWrong) {
    const configs = ModelConfig.get();
    //var url = configs.urlBase
    var url = BaseConfig.urlBase + +"/api/NivelMercadoLogicos/GetAllCategorias";
  ...
  async getSubCategories(categoriaId, callbackOk, callbackWrong) {
    ...
    var url =
      BaseConfig.urlBase +
      "/api/NivelMercadoLogicos/GetSubCategoriaByIdCategoria?CategoriaID=" +
      categoriaId;
  ...
  async getSubFamilia(
    { categoryId, subcategoryId, familyId },
    callbackOk,
    callbackWrong
  ) {
    const configs = ModelConfig.get();
  ...
  async getProductsNML(
    ...
    var url =
      BaseConfig.urlBase +
      "/api/ProductosTmp/GetProductosByIdNML?idcategoria=" +
      catId +
      "&idsubcategoria=" +
      subcatId +
      "&idfamilia=" +
  ...
  async getProductsFastSearch(callbackOk, callbackWrong) {
    const configs = ModelConfig.get();
    //var url = configs.urlBase
    var url = BaseConfig.urlBase + "/api/ProductosTmp/ProductosVentaRapidaGet";
    url += "?codigoSucursal=" + ModelConfig.get("sucursal");
    url += "&puntoVenta=" + ModelConfig.get("puntoVenta");
  ...
  async addProductFastSearch(product, callbackOk, callbackWrong) {
    const configs = ModelConfig.get();
    // var url = configs.urlBase +
    var url = BaseConfig.urlBase + "/api/ProductosTmp/ProductosVentaRapidaPost";

    if (!product.codigoSucursal)
      product.codigoSucursal = ModelConfig.get("sucursal");
  ...
  async changeProductFastSearch(product, callbackOk, callbackWrong) {
    const configs = ModelConfig.get();
    //var url = configs.urlBase
    var url = BaseConfig.urlBase + +"/api/ProductosTmp/ProductosVentaRapidaPut";
  ...
  async removeProductFastSearch(product, callbackOk, callbackWrong) {
    ...
    // var url = configs.urlBase
    var url =
      BaseConfig.urlBase + +"/api/ProductosTmp/ProductosVentaRapidaDelete";
  ...
  async assignPrice(product, callbackOk, callbackWrong) {
    const configs = ModelConfig.get();
    //var url = configs.urlBase
    var url = BaseConfig.urlBase + "/api/ProductosTmp/UpdateProductoPrecio";
  ...
  async newProductFromCode(product, callbackOk, callbackWrong) {
    const configs = ModelConfig.get();
    //var url = configs.urlBase
    var url = BaseConfig.urlBase + "/api/ProductosTmp/AddProductoNoEncontrado";
  ...
  async getTipos(callbackOk, callbackWrong) {
    const configs = ModelConfig.get();
    //var url = configs.urlBase
    var url = BaseConfig.urlBase + +"/api/ProductosTmp/GetProductoTipos";
    url += "?codigoSucursal=" + ModelConfig.get("sucursal");
    url += "&puntoVenta=" + ModelConfig.get("puntoVenta");
